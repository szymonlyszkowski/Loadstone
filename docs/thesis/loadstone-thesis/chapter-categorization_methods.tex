...
First step to obtain a class to which training data are belonging is posterior probability, $P(c_j |d_i )$. Basing on this probability and multinomial model \cite{5}we can conclude:
\begin{equation}
